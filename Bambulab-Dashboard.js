...
const styles = `
  ...
  * { box-sizing: border-box; }
  ...
  .shell.theme-light {
    --bd-bg:#f4f7f5; --bd-panel:#ffffff; --bd-panel-2:#eef4f0; --bd-border:#d5e0d9;
...
class BambuLabDashboard extends HTMLElement {
  ...
  _officialMaintenanceTasks(printer){
    ...
    if(model==="X2D") return [
      {id:"build_plate",name:"Build Plate reinigen",days:7,alwaysVisible:true,source:"X2D User Manual · Kap. 11",url:"https://csm.bblcdn.com/hub/7c58718aaa2e40edab56efb87419a96a.pdf#page=137",note:"Mit warmem Wasser und Spülmittel reinigen und vollständig trocknen. Bambu Lab nennt bei normaler Nutzung 1 Woche."},
      {id:"live_camera",name:"Live-View-Kamera reinigen",days:30,intensiveDays:7,source:"X2D User Manual · Kap. 11",url:"https://csm.bblcdn.com/hub/7c58718aaa2e40edab56efb87419a96a.pdf#page=137",note:"Kamerafläche mit Wattestäbchen oder fusselfreiem Tuch und wenig Alkohol reinigen. Normal: 1 Monat; bei intensiver Nutzung laut Bambu wöchentlich."},
      {id:"chamber",name:"Druckraum / Boden reinigen",days:30,intensiveDays:7,alwaysVisible:true,source:"X2D User Manual · Kap. 11",url:"https://csm.bblcdn.com/hub/7c58718aaa2e40edab56efb87419a96a.pdf#page=138",note:"Filamentreste und Fremdkörper abbürsten, anschließend mit einem fusselfreien, leicht mit Alkohol angefeuchteten Tuch reinigen. Normal: 1 Monat."},
      {id:"xy_axes",name:"X-/Y-Achsen reinigen & schmieren",days:30,intensiveDays:7,source:"X2D User Manual · Kap. 11",url:"https://csm.bblcdn.com/hub/7c58718aaa2e40edab56efb87419a96a.pdf#page=139",note:"X/Y-Linearführungen reinigen und danach mit Schmieröl ölen. Normal: 1 Monat. Nach Wartung wichtiger Achskomponenten empfiehlt Bambu eine vollständige Druckkalibrierung."},
      {id:"z_axis",name:"Z-Achse reinigen & schmieren",days:90,intensiveDays:30,source:"X2D User Manual · Kap. 11",url:"https://csm.bblcdn.com/hub/7c58718aaa2e40edab56efb87419a96a.pdf#page=140",note:"Linearführungen mit Schmieröl, Gewindespindeln mit Schmierfett behandeln – die Schmierstoffe nicht verwechseln. Normal: 3 Monate."},
      {id:"air_filter",name:"Luftfilter prüfen / reinigen",days:90,intensiveDays:30,source:"X2D User Manual · Kap. 11",url:"https://csm.bblcdn.com/hub/7c58718aaa2e40edab56efb87419a96a.pdf#page=138",note:"Filterabdeckung von Staub befreien. Aktivkohlefilter regelmäßig ersetzen, insbesondere wenn er sichtbar verschmutzt oder gesättigt ist. Normal: 3 Monate."},
      {id:"toolhead_camera",name:"Toolhead-Kamera reinigen",days:30,intensiveDays:7,source:"X2D User Manual · Kap. 11",url:"https://csm.bblcdn.com/hub/7c58718aaa2e40edab56efb87419a96a.pdf#page=143",note:"Kamerafläche mit Wattestäbchen oder fusselfreiem Tuch und wenig Alkohol reinigen. Ablagerungen können Bild und Erkennung beeinträchtigen. Normal: 1 Monat."},
      {id:"extruder",name:"Extruder reinigen & schmieren",days:30,intensiveDays:7,source:"X2D User Manual · Kap. 11",url:"https://csm.bblcdn.com/hub/7c58718aaa2e40edab56efb87419a96a.pdf#page=142",note:"Interne Ablagerungen entfernen und die vorgesehenen Zahnräder mit Schmierfett schmieren. Normal: 1 Monat; für die Demontage verweist Bambu auf die X2D-Anleitung im Wiki."},
      {id:"hotend",name:"Hotend reinigen",days:30,intensiveDays:7,source:"X2D User Manual · Kap. 11",url:"https://csm.bblcdn.com/hub/7c58718aaa2e40edab56efb87419a96a.pdf#page=138",note:"Bambu nennt für die regelmäßige Hotend-Reinigung einen Cold Pull. Normal: 1 Monat."}
    ];
    if(model==="A2L") return [
      {id:"moving_parts",name:"Schienen / Führungen / Rollen / Lead Screws schmieren",days:null,alwaysVisible:true,source:"A2L Quick Start · Regular Maintenance",url:"https://csm.bblcdn.com/hub/4efdb4e04ab34111a8da112e81028430.pdf",note:"X/Y und Umlenkrollen mit Öl; Lead Screws und Extruder-Zahnräder mit Fett. Bambu nennt im A2L Quick Start kein fixes Zeitintervall – deshalb erfolgt hier keine erfundene Fälligkeitsberechnung."},
      {id:"consumables",name:"Filament-Cutter, Wiper und PTFE prüfen",days:null,alwaysVisible:true,source:"A2L Quick Start · Regular Maintenance",url:"https://csm.bblcdn.com/hub/4efdb4e04ab34111a8da112e81028430.pdf",note:"Auf Alterung, Verformung und Verschleiß prüfen; bei Bedarf ersetzen. Ohne Herstellerintervall wird kein Datum berechnet."},
      {id:"camera_fans",name:"Kamera, Lüfter und Filamentsensor reinigen",days:null,alwaysVisible:true,source:"A2L Quick Start · Regular Maintenance",url:"https://csm.bblcdn.com/hub/4efdb4e04ab34111a8da112e81028430.pdf",note:"Staub und Schmutz entfernen; Kamera vorsichtig reinigen. Ohne Herstellerintervall wird kein Datum berechnet."}
    ];
    return [];
  }
